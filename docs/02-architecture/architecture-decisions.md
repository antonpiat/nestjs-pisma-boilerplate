...
We needed to decide on an architectural pattern for the NestJS Prisma boilerplate that would provide clear separation of concerns, maintainability, and testability.
...
We needed to decide whether to include two-factor authentication in the boilerplate.
...
These architecture decisions form the foundation of the NestJS Prisma boilerplate's design, providing a robust, scalable, and maintainable architecture for building backend applications.
